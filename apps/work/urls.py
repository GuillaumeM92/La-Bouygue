...
from . import views
from .views import (WorkListView, WorkDoneListView, WorkCreateView,
                    WorkUpdateView, WorkDeleteView, UserWorkListView,
                    WorkCommentUpdateView, WorkCommentDeleteView)

urlpatterns = [
    path("work/", WorkListView.as_view(), name="work"),
    path("work/done", WorkDoneListView.as_view(), name="work-done"),
    path("work/user/<str:surname>/<str:name>",
         UserWorkListView.as_view(), name="user-work"),
