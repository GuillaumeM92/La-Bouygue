...
document.addEventListener('DOMContentLoaded', function () {
    ...
    $(window).on("click", function (e) {
        if (e.target.name == 'end_date' && ($('#calendarbox0').css('display') != 'block')) {
            $('#calendarbox1').css({ 'display': 'block', 'left': (e['pageX']), 'top': (e['pageY'] - 87), 'background': 'dark' })
            $('#calendarbox3').css({ 'display': 'block', 'left': (e['pageX']), 'top': (e['pageY'] - 87), 'background': 'gray' })
        }
            ...
            $('#calendarbox0').css({ 'display': 'block', 'left': (e['pageX']), 'top': (e['pageY'] - 87), 'background': 'dark' })
            $('#calendarbox2').css({ 'display': 'block', 'left': (e['pageX']), 'top': (e['pageY'] - 87), 'background': 'gray' })
        }
