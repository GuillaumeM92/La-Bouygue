...
from .views import (ActivityListView, ActivityCreateView, ActivityUpdateView, ActivityDeleteView,
                    UserActivityListView, ActivityCommentUpdateView, ActivityCommentDeleteView)

urlpatterns = [
    path('activities/', ActivityListView.as_view(), name='activities'),
    path('activities/user/<str:surname>/<str:name>',
         UserActivityListView.as_view(), name='user-activities'),
    ...
    path('activities/comment/<int:pk>/update/',
         ActivityCommentUpdateView.as_view(), name='activitycomment-update'),
    path('activities/comment/<int:pk>/delete/',
         ActivityCommentDeleteView.as_view(), name='activitycomment-delete'),
]
