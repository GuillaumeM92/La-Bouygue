    ...
    def clean(self):
        ...
        try:
            if end_date < start_date:
                cleaned_data.update({'error_message' : "LA DATE DE FIN DOIT ÊTRE POSTÉRIEURE À LA DATE DE DÉBUT !"})
                raise forms.ValidationError("End date should be greater than start date.")
        except TypeError:
            cleaned_data.update({'error_message' : "LE FORMAT DE LA DATE EST INVALIDE ! MERCI DE RÉESSAYER."})
